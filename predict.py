...
class SysidModel():
    ...
    def plot_in_out(self, Y, Y_pred, mse, mse2, Y2, Y2_pred, history):
        ...
        # labels
        data_label1 = 'beta [unit]'
        data_label2 = 'p [unit]'
        data_label3 = 'q [unit]'
        data_label4 = 'roll [unit]'
    ...
    def fit_model(self):
        ...
        #                        delimiter=",")
        dataset_s = np.loadtxt("../data/Smoothed_Data/out_smooth2.csv",
                               delimiter=",")
        s = dataset_s[:, 0:4]
        ...
        #                        delimiter=",")
        dataset_a = np.loadtxt("../data/Smoothed_Data/in_smooth2.csv",
                               delimiter=",")
        a = dataset_a[:, 0:2]
